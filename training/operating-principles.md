...
There are a number of important concepts hidden in these principles:
 ...
 - We do not focus on through and complete design before we build. We focus on working code. We try to get prototypes up an running quickly. Through this process we discover requirements organically. We believe this is a much faster, and more through, way to gather requirements.
